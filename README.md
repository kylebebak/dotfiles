...
The most interesting ones use [pick](https://github.com/thoughtbot/pick) and [yank](https://github.com/mptre/yank) to create utilify functions that leverage fuzzy select.
